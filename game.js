        var lblPuan, tual, cizimAlani, mevcutYon, eskiYon, bas, w, h, b, puan, timer;
        var adimBoyutu = 10;
        var hucreler = [];
        var yem = [];
        ...
        window.onkeydown = function (key) {
            ...
            if (key.keyCode == yonler.sag && eskiYon != yonler.sol) {
                mevcutYon = key.keyCode;

            }
            else if (key.keyCode == yonler.sol && eskiYon != yonler.sag) {
                mevcutYon = key.keyCode;
            }
            else if (key.keyCode == yonler.ust && eskiYon != yonler.alt) {
                mevcutYon = key.keyCode;
            }
            else if (key.keyCode == yonler.alt && eskiYon != yonler.ust) {
                mevcutYon = key.keyCode;
            }
            b = 1;
        }
